...
async def start_yukki():
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await aan(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await aan(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            await aan(functions.channels.JoinChannelRequest(channel=" @BLACK_DRAGON_FIGHTER_CLAN"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("💦𝐑𝐔𝐊 𝐓𝐄𝐑𝐀 𝐁𝐀𝐀𝐏 𝐀𝐀𝐑𝐀 𝐇𝐀𝐈💦")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐆𝐑𝐎𝐔𝐏 𝐊𝐈 𝐌𝐀 𝐂𝐇𝐎𝐃𝐄𝐆𝐄 𝐀𝐁")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "👿𝐁𝐀𝐀𝐏 𝐊𝐈 𝐒𝐏𝐄𝐄𝐃 𝐃𝐄𝐊𝐇𝐄𝐆𝐀 𝐁𝐄𝐓𝐀👿"
        event = await e.reply(text, parse_mode=None, link_preview=None)
        end = datetime.now()
        ms = (end - start).microseconds / 1000
        await event.edit(f"💦 𝐙𝐈𝐍𝐃𝐀 𝐇𝐔 𝐋𝐀𝐕𝐃𝐄 !\n`{ms}` 𝗺𝘀\n 𝐁𝐋𝐀𝐂𝐊 𝐃𝐑𝐀𝐆𝐎𝐍 𝐅𝐈𝐆𝐇𝐓𝐄𝐑")
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = "𝗥𝗲𝘀𝘁𝗮𝗿𝘁𝗲𝗱...\n\n𝐑𝐔𝐊𝐍𝐀 𝐌𝐀𝐃𝐀𝐑𝐂𝐇𝐎𝐃 𝐑𝐄𝐒𝐓𝐀𝐑𝐓 𝐇𝐎 𝐑𝐇𝐀 𝐇𝐔 𝐍..."
        await e.reply(text, parse_mode=None, link_preview=None )
        try:
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = " ⚔ 𝐁𝐋𝐀𝐂𝐊 𝐃𝐑𝐀𝐆𝐎𝐍 𝐅𝐈𝐆𝐇𝐓𝐄𝐑 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 ⚔\n\n✘ 𝐔𝐓𝐈𝐋𝐒 ✘:\n.ping\n.restart\n\n✘ 𝐔𝐒𝐄𝐑 𝐁𝐎𝐓 ✘:\n.bio\n.join\n.pjoin\n.pleave\n\n✘ 𝐒𝐏𝐀𝐌 ✘:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n [ MADARCHOD ]"
       await e.reply(text, parse_mode=None, link_preview=None )
...
print(text)
print("")
print("ʏᴏᴜʀ ʙʟᴀᴄᴋ ᴅʀᴀɢᴏɴ ʙᴏᴛ ᴅᴇᴘʟᴏʏ !!")
